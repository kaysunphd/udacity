...
def go(args):
    ...
    # Convert columns from object to string type
    object_columns = X_val.select_dtypes(include=['object']).columns.tolist()
    X_val[object_columns] = X_val[object_columns].astype(str)
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Random forest trained pipeline export"
    )
